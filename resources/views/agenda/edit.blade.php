...
<div class="container-fluid">
    <h2 class="mb-4"><i class="bi bi-pencil"></i> Edit Agenda</h2>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="tanggal_mulai" class="form-control" required value="{{ old('tanggal_mulai', $agenda->tanggal_mulai) }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Waktu Mulai *</label>
                        <input type="time" name="waktu_mulai" class="form-control" required value="{{ old('waktu_mulai', $agenda->waktu_mulai) }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Tanggal Selesai</label>
                        <input type="date" name="tanggal_selesai" class="form-control" value="{{ old('tanggal_selesai', $agenda->tanggal_selesai) }}">
                    </div>
                    <div class="col-md-3 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="url" name="link_meeting" class="form-control" value="{{ old('link_meeting', $agenda->link_meeting) }}">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="penyelenggara" class="form-control" value="{{ old('penyelenggara', $agenda->penyelenggara) }}">
                    </div>
                    <div class="col-md-12 mb-3">
                        <label class="form-label">Perlengkapan yang Dibawa</label>
                        <textarea name="perlengkapan_dibawa" class="form-control" rows="2">{{ old('perlengkapan_dibawa', $agenda->perlengkapan_dibawa) }}</textarea>
                    </div>
                </div>
            </div>
        </div>

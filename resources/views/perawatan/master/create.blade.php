...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Tambah Master Checklist</h2>
                <div class="text-muted mt-1">Buat template checklist perawatan gedung</div>
            </div>
...
<div class="page-body">
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form action="{{ route('perawatan.master.store') }}" method="POST">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kegiatan" class="form-control @error('nama_kegiatan') is-invalid @enderror" 
                                    placeholder="Contoh: Buang Sampah Ruang Tamu" value="{{ old('nama_kegiatan') }}" required>
                                @error('nama_kegiatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-hint">Nama kegiatan yang akan dilakukan</small>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                                <textarea name="deskripsi" rows="3" class="form-control @error('deskripsi') is-invalid @enderror" 
                                    placeholder="Detail kegiatan perawatan...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-hint">Penjelasan detail tentang kegiatan ini (opsional)</small>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="tipe_periode" id="tipe_periode" class="form-select @error('tipe_periode') is-invalid @enderror" required>
                                            ...
                                            <option value="harian" {{ old('tipe_periode') == 'harian' ? 'selected' : '' }}>
                                                Harian (Reset setiap hari)
                                            </option>
                                            <option value="mingguan" {{ old('tipe_periode') == 'mingguan' ? 'selected' : '' }}>
                                                Mingguan (Reset setiap minggu)
                                            </option>
                                            <option value="bulanan" {{ old('tipe_periode') == 'bulanan' ? 'selected' : '' }}>
                                                Bulanan (Reset setiap bulan)
                                            </option>
                                            <option value="tahunan" {{ old('tipe_periode') == 'tahunan' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                                            ...
                                            <option value="perawatan_rutin" {{ old('kategori') == 'perawatan_rutin' ? 'selected' : '' }}>
                                                🔧 Perawatan Rutin
                                            </option>
                                ...
                                <select name="kode_jam_kerja" class="form-select @error('kode_jam_kerja') is-invalid @enderror">
                                    ...
                                    @if(isset($jamKerjas))
                                        @foreach($jamKerjas as $jam)
                                            <option value="{{ $jam->kode_jam_kerja }}" {{ old('kode_jam_kerja') == $jam->kode_jam_kerja ? 'selected' : '' }}>
                                ...
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info mb-0">
                                            ...
                                            <br><strong>Contoh:</strong> Jam 08:00-17:00 akan tampil untuk Shift Pagi (08:00-20:00) tapi tidak tampil untuk Shift Malam (20:00-08:00)
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="jadwal_mingguan" style="display: none;">
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label required">Hari Target</label>
                                            <select name="hari_minggu" class="form-select">
                                                <option value="">Pilih Hari...</option>
                                                <option value="1" {{ old('hari_minggu') == '1' ? 'selected' : '' }}>Senin</option>
                                                <option value="2" {{ old('hari_minggu') == '2' ? 'selected' : '' }}>Selasa</option>
                                                <option value="3" {{ old('hari_minggu') == '3' ? 'selected' : '' }}>Rabu</option>
                                                <option value="4" {{ old('hari_minggu') == '4' ? 'selected' : '' }}>Kamis</option>
                                                <option value="5" {{ old('hari_minggu') == '5' ? 'selected' : '' }}>Jumat</option>
                                                <option value="6" {{ old('hari_minggu') == '6' ? 'selected' : '' }}>Sabtu</option>
                                                <option value="7" {{ old('hari_minggu') == '7' ? 'selected' : '' }}>Minggu</option>
                                            </select>
                            ...
                            <div id="jadwal_bulanan" style="display: none;">
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label required">Tanggal Target</label>
                                            <input type="number" name="tanggal_bulan" class="form-control" min="1" max="31" 
                                                placeholder="1-31" value="{{ old('tanggal_bulan') }}">
                                            <small class="form-hint">Checklist akan muncul setiap tanggal ini setiap bulan</small>
                                        </div>
                                        <div class="alert alert-warning mb-0">
                                            <strong>Perhatian:</strong> Jika memilih tanggal 29-31, checklist tidak akan muncul di bulan yang tidak memiliki tanggal tersebut (misal: Februari)
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="jadwal_tahunan" style="display: none;">
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label required">Tanggal Target</label>
                                            <input type="date" name="tanggal_target" class="form-control" value="{{ old('tanggal_target') }}">
                                            <small class="form-hint">Checklist akan muncul setiap tahun di tanggal ini (misal: 31 Desember untuk tutup buku)</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-info">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h4 class="alert-title">Info Periode</h4>
                                        <div class="text-muted">
                                            <ul class="mb-0">
                                                <li><strong>Harian:</strong> Checklist akan direset setiap hari (00:00)</li>
                                                <li><strong>Mingguan:</strong> Reset setiap awal minggu (Senin)</li>
                                                <li><strong>Bulanan:</strong> Reset setiap tanggal 1</li>
                                                <li><strong>Tahunan:</strong> Reset setiap 1 Januari</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

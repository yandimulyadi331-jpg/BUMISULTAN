...
@section('content')
    ...
    <div id="header-section">
        <div id="section-back">
            <a href="{{ route('majlistaklim.karyawan.hadiah.index') }}" class="back-btn">
...
$(document).ready(function() {
    $('#formHadiah').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("majlistaklim.karyawan.hadiah.store") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            success: function(response) {
                ...
                window.location.href = '{{ route("majlistaklim.karyawan.hadiah.index") }}';
            },
            error: function(xhr) {

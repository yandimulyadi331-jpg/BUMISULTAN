...
@section('content')
    ...
    <div id="header-section">
        <div class="logo-wrapper">
            <span class="logo-title">YAYASAN MUHAMMAD SULTAN RAMADHAN</span>
    ...
    <div id="content-section">
        ...
        <div class="menu-grid">
            <!-- Data Jamaah -->
            <a href="{{ route('majlistaklim.karyawan.jamaah.index') }}" class="menu-card">
                <div class="menu-icon">
            ...
            <!-- Distribusi Hadiah -->
            <a href="{{ route('majlistaklim.karyawan.distribusi.index') }}" class="menu-card">
                <div class="menu-icon">
            ...
            <!-- Laporan -->
            <a href="{{ route('majlistaklim.karyawan.laporan.index') }}" class="menu-card">
                <div class="menu-icon">

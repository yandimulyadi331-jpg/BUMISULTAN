...
<div class="bg-primary" style="padding: 2.5rem 0; margin: -1.5rem -1.5rem 1.5rem -1.5rem;">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('pinjaman-ibu.download-formulir-blank') }}" class="btn btn-danger btn-lg me-2" target="_blank">
                    <i class="bi bi-file-pdf"></i> Download Formulir Kosong
                </a>
                <a href="{{ route('pinjaman-ibu.create') }}" class="btn btn-success btn-lg">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('pinjaman-ibu.index') }}" id="filterForm">
            <div class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('pinjaman-ibu.index') }}" class="btn btn-secondary">
...
<div class="card">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('pinjaman-ibu.laporan') }}" class="btn btn-light btn-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                <a href="{{ route('pinjaman-ibu.show', $item->id) }}" class="btn btn-info btn-action" title="Lihat Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                
                                <!-- Tombol Edit -->
                                <a href="{{ route('pinjaman-ibu.edit', $item->id) }}" 
                                ...
                                <form id="delete-form-{{ $item->id }}" 
                                      action="{{ route('pinjaman-ibu.destroy', $item->id) }}" 
                                      method="POST" 
                                      style="display: none;">
                                    @csrf
                                    @method('DELETE')

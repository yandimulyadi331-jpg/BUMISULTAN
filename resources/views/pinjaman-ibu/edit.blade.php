...
<div class="bg-primary" style="padding: 2rem 0; margin: -1.5rem -1.5rem 1.5rem -1.5rem;">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('pinjaman-ibu.show', $pinjaman->id) }}" class="btn btn-light">
...
<form action="{{ route('pinjaman-ibu.update', $pinjaman->id) }}" method="POST" enctype="multipart/form-data" id="formPinjaman">
    @csrf
    @method('PUT')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <a href="{{ route('pinjaman-ibu.index') }}" class="btn btn-secondary btn-lg">

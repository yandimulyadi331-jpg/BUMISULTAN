...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('pinjaman-ibu.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('pinjaman-ibu.laporan') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('pinjaman-ibu.laporan') }}" class="btn btn-outline-secondary">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <form method="GET" action="{{ route('pinjaman-ibu.laporan') }}" class="d-inline">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('pinjaman-ibu.show', $item->id) }}" class="text-decoration-none">
                                    {{ $item->nomor_pinjaman }}
                                </a>
                            </td>

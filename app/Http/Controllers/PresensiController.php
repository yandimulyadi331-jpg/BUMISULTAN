                ...
                if ($presensi_hariini && $presensi_hariini->jam_in != null) {
                    ...
                    try {
                        if ($presensi_hariini != null) {
                            ...
                            // Tambahkan notifikasi real-time untuk update presensi masuk
                            $presensi_updated = Presensi::find($presensi_hariini->id);
                            NotificationService::presensiNotification($presensi_updated, 'masuk');
                        } else {
                            ...
                            // Tambahkan notifikasi real-time untuk presensi masuk
                            NotificationService::presensiNotification($presensi_baru, 'masuk');
                        }
                        ...
                        if ($generalsetting->notifikasi_wa == 1) {
                            if ($generalsetting->tujuan_notifikasi_wa == 1) {
                                ...
                                // Validasi id_group_wa tidak null/kosong
                ...
                if ($presensi_hariini && $presensi_hariini->jam_out != null) {
                    ...
                    try {
                        if ($presensi_hariini != null) {
                            ...
                            // Tambahkan notifikasi real-time untuk presensi pulang
                            $presensi_updated = Presensi::find($presensi_hariini->id);
